#_(ns rovers.main
  (:require
   ...
   [rovers-api.chan :as scenario-api.chan]
   [rovers-api.spec :as scenario-api.spec]

   [rovers.player.spec :as player.spec]
   [rovers.player.chan :as player.chan]

   [rovers.spec :as scenario.spec]
   [rovers.chan :as scenario.chan]
   [rovers.impl :as scenario.impl]

   [rovers.main.spec :as scenario.main.spec]
   [rovers.main.chan :as scenario.main.chan]

   [rovers.core :as scenario.core]
   [rovers.render :as scenario.render]))
